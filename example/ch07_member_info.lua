--[[
    Chapter 07: member information for future constraints.
]]
...
local function createMemberInfo(memberType, style, typeTable, inheritable)
    return
    {
    ...
    local function Field()
        return createProxy
        {
            ...
            __newindex = function(_, fieldName, initValue)
                ...
                typeMeta.memberInfoMap[fieldName] = createMemberInfo("field", "", theType, true)
            end;
        }
    end
